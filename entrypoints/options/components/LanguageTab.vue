  ...
  <div class="space-y-8">
    <div class="space-y-1">
      ...
      <p class="text-muted-foreground text-sm">
        Configure language detection, grammar checking, and translation
        preferences.
      </p>
    </div>
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Your primary writing language when auto-detect is off.
        </CardDescription>
      </CardHeader>
      <CardContent class="grid gap-4 md:grid-cols-2">
        ...
        <div
          class="col-span-full flex items-start gap-3 rounded-lg border bg-card/30 p-4"
        >
          <Switch
            v-model:checked="settings.autoDetect"
            aria-label="Toggle language auto-detection"
          ...
          <div class="space-y-1">
            ...
            <p class="text-xs text-muted-foreground">
              Automatically detect the language of your text and apply
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Select which languages to check for grammar errors.
        </CardDescription>
      </CardHeader>
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Force a specific language for certain websites.
        </CardDescription>
      </CardHeader>
      <CardContent class="space-y-4">
        <div
          v-if="Object.keys(settings.perSiteOverrides).length"
          class="space-y-2"
        >
          <div
        ...
        <div
          v-else
          class="rounded-lg border border-dashed bg-card/30 p-4 text-center text-sm text-muted-foreground"
        >
